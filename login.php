        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item mx-0 mx-lg-1">
              <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="index.php">Portfolio</a>
            </li>
            <li class="nav-item mx-0 mx-lg-1">
...
Email <br><input type="email" name="email-login" size="40"><br>
Password <br><input type="password" name="pass-login" size="40"><br>
